...
#include OATPP_CODEGEN_BEGIN(ApiClient)
  ...
  API_CALL("GET", "test1", doGetAnything, PATH(String, parameter))
  ...
  API_CALL_ASYNC("GET", "test1", doGetAsync)
  ...
  API_CALL_ASYNC("GET", "test1", doGetAnythingAsync, PATH(String, parameter))
